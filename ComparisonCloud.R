...
#draw_FourWayComparisonCloud = function(my_file){
  ...
  # Suurin kvartaali on "paras" eli sielä olevat sanat on "parhaita" tai arvostetuimmissa lähteissä.
  # Eli mitkä trendaa, eli mitkä on kuumia topicceja, eli mitkä kannattaa laittaa työhakemukseen
