...
#get_ScopusData = function(query_string, my_filename){
  ...
  #EDIT this line
  my_query_string = paste(my_query_string, "\") AND ALL(\"software testing\") AND (SUBJAREA('COMP') OR SUBJAREA('ENGI'))", sep="")
#my_query_string = paste(my_query_string, "\") AND ALL(\"balanced between\" OR \"automation\" OR \"manual\")", sep="")
  #my_query_string = paste(my_query_string, "\") AND ALL(\"balanced between\" OR \"automation\" OR \"manual\") AND (SUBJAREA('COMP') OR SUBJAREA('ENGI'))", sep="")
